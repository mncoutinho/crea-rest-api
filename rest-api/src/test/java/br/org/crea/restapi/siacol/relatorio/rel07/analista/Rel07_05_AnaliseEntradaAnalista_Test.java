...
public class Rel07_05_AnaliseEntradaAnalista_Test {
	...
	public void entradaAnalise() {
		...
		try {
			...
			List<ProtocolosRel07RecebimentoDto> listaRelatorio = dao.getEntradaAnaliseAnalista(populaPesquisa(), listaProtocolosRecebimento);
			
			listaProtocolosRecebimento.forEach(protocolo -> {
				System.out.print(protocolo + ", ");
			});
			
			System.out.println("\nId Aud. | No. Protocolo | Data");
