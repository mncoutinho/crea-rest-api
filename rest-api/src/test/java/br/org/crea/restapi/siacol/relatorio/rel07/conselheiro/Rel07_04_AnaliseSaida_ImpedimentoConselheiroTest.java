...
public class Rel07_04_AnaliseSaida_ImpedimentoConselheiroTest {
...
//	@Test
	public void saidaAnaliseImpedimento() {
		
		try {
			Long idAssuntoSiacol = 51L;
			ProtocolosRel07RecebimentoDto relatorio = dao.getSaidaAnaliseImpedimentoConselheiro(populaPesquisa(), idAssuntoSiacol);
