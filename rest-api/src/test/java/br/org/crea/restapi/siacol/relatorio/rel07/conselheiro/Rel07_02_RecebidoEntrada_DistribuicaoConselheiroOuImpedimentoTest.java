...
public class Rel07_02_RecebidoEntrada_DistribuicaoConselheiroOuImpedimentoTest {
	...
	@Test
	public void distribuicaoConselheiroOuImpedimentoTest() {
		...
		try {
			...
			for (ProtocolosRel07RecebimentoDto recebimento : listaRelatorio) {
				ProtocolosRel07RecebimentoDto relatorio = dao.getDistribuicaoConselheiroOuImpedimento(populaPesquisa(), idAssuntoSiacol, recebimento.getIdAuditoria());
