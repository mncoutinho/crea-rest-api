...
public class Rel07_09_VinculoEntrada_Test {
	...
	@Test
	public void entradaVinculo() {
		
		try {
			Long idAssuntoSiacol = 47L;
			List<ProtocolosRel07RecebimentoDto> listaRelatorio = dao.getEntradaVinculoAnalista(populaPesquisa(), idAssuntoSiacol);
