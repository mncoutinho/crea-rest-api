 ...
 * @since 07/2018
 * Teste para assinar documento que está armazenado no formato json, cujo referências estão em cad-documentos.
 * O serviço deve ser capaz de montar o pdf representado pelo json e assinar o documento.
 * */
public class AssinaturaDocumentoJsonTest {
