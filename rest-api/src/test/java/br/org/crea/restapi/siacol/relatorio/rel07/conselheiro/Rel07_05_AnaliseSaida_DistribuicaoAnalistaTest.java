...
public class Rel07_05_AnaliseSaida_DistribuicaoAnalistaTest {
...
//	@Test
	public void saidaAnaliseDistribuicaoAnalista() {
		
		try {
			Long idAssuntoSiacol = 51L;
			ProtocolosRel07RecebimentoDto relatorio = dao.getSaidaAnaliseDistribuicao(populaPesquisa(), idAssuntoSiacol);
