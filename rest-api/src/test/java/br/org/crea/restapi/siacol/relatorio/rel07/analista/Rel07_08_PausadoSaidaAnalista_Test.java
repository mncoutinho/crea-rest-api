...
public class Rel07_08_PausadoSaidaAnalista_Test {
	...
	@Test
	public void saidaPausados() {
		
		try {
			Long idAssuntoSiacol = 47L;
			ProtocolosRel07RecebimentoDto saidaPausado = null;
			List<ProtocolosRel07RecebimentoDto> listaSaidaPausado = new ArrayList<ProtocolosRel07RecebimentoDto>();
			...
			List<ProtocolosRel07RecebimentoDto> listaEntradaPausado = dao.getEntradaPausadosAnalista(populaPesquisa(), listaProtocolosRecebimento);
			
			for (ProtocolosRel07RecebimentoDto entradaPausado : listaEntradaPausado) {
				saidaPausado = dao.getSaidaPausadosAnalista(populaPesquisa(), entradaPausado);
				if (saidaPausado != null) listaSaidaPausado.add(saidaPausado);
			}
			
			System.out.println("Id Auditoria | No. Protocolo | Data");
			listaSaidaPausado.forEach(saida -> {
