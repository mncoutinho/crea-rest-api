...
public class Relatorio03XlsTest {

   private List<RelSiacol03Dto> listRel;
   ...
   private SiacolRelXlsBuilder builder;
	...
	public void relatoriosTest() {
		...
		try {
			...
			bos.write(builder.rel03(listRel));
			bos.close();
	...
	private List<RelSiacol03Dto> mockRel() {
		List<RelSiacol03Dto> listRel = new ArrayList<>();
